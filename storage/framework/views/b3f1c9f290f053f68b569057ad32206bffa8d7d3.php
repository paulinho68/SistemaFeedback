...
<ol class="breadcrumb">
    <li><a href="<?php echo e(route('user.index')); ?>"><i class="fa fa-dashboard"></i> Usuários</a></li>
...
<div class="container">
    <div class="box">
        ...
        <div class="box-body">
            ...
            <?php endif; ?>
            <?php echo e(Form::open(array('url' => 'admin/user/create'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andrereis\projetos\workspace\feedback\resources\views/users/users_create.blade.php ENDPATH**/ ?>